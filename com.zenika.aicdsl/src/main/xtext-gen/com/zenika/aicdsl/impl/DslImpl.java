 ...
 * </p>
 * <ul>
 *   <li>{@link com.zenika.aicdsl.impl.DslImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DslImpl extends MinimalEObjectImpl.Container implements Dsl
{
  ...
  {
    return AicdslPackage.Literals.DSL;
  }
  ...
  public EList<Type> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Type>(Type.class, this, AicdslPackage.DSL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AicdslPackage.DSL__ELEMENTS:
